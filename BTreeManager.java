...
public class BTreeManager {
		...
		if (nodeToSplit.giveParent() == -1) {
			...
			if (parent.getNumChild() < 5) {
				...
				try {
					...
					System.out.println("Error at insert method of BTreeManager.");
				}
	...
	public void createFirstNode() {
		// create a node object which will accept the array
		// and then increment numRecords by 1, this node will be the root node
	...
	// to be used for when creating nodes from existing .bt files
